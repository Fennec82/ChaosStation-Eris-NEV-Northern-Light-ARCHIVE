...
//	wl_config_heads = TRUE		//Eclipse edit.
	...
	description = "You are the head of Moebius research on the Eris, tasked with directing shipboard research to new and profitable discoveries."
...
Organise away missions to gather artefacts and research interesting environments. You have the right to request support from other departments as required"
	...
	loyalties = "Your first loyalty is to Moebius. In order to ensure it can continue its mission of research, it must remain profitable. Ensure its interests are farthered, and take care of your colleagues in both the research and medical wings.<br>\
...
/datum/job/scientist
	...
	alt_titles = list("Xenobiologist", "Xenoflorist", "Research Intern", "Anomalist", "Explorer")
...
Explore, learn and adventure, do anything to advance the cause of knowledge"
	...
	Your second loyalty is to Moebius MedSci. In order to ensure it can continue its mission of research, it must remain profitable. Ensure its interests are farthered, and take care of your colleagues in both the research and medical wings"
